...
export default class Refer extends Component {
    ...
    _fancyShareMessage=()=>{
        var a = 'Hey! Checkout Anytimedoc app. ' +'https://play.google.com/store/apps/details?id=com.anytimedoc' +' .Use my referral code ' + GLOBAL.referal+ ' to get 500 wallet points.'
                ...
                <SafeAreaView style={{flex:1}}>
                    <View style={{width : Dimensions.get('window').width,height: Dimensions.get('window').height,backgroundColor:'#F2F5F7'}}>
                        <View style={{width : Dimensions.get('window').width,height : Dimensions.get('window').height-250,flexDirection:'column',backgroundColor:'white'}}>
                            ...
                            <Text style={{fontSize:12,fontFamily:'Poppins-Regular',color:'#575353',alignSelf:'center',marginTop:10,marginLeft:15,marginRight:15}}>Get 500 anytimedoc point for each friend that signup and complete a transaction. They get 500 points as well</Text>
